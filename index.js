...
describe('Default Suite', function() {
  ...
  it('Create invoice', async function() {
    ...
    await driver.wait(until.elementLocated(By.css('#modal-invoice-success > div > div > div.modal-body.modal-body-full > div > div > div > div > button')),10000);

    // 17 | click | css=.col-sm-6 > .btn:nth-child(5) |
    await driver.findElement(By.css('#modal-invoice-success > div > div > div.modal-body.modal-body-full > div > div > div > div > button')).click()
  })
})
